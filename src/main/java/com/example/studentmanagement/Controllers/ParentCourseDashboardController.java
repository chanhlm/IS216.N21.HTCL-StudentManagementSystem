...
public class ParentCourseDashboardController implements Initializable {
    ...
    private void getRenderCourseList(){
        try {
            ...
            String sqlCourseTeacherClass = "SELECT " +
                    ...
                    " WHERE course.class_id = " + userLoggedIn.getCurrent_children_viewing().getClassEnitity().getClass_id() +
