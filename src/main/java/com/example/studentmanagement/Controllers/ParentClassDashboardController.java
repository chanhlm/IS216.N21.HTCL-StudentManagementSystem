...
public class ParentClassDashboardController implements Initializable {
    private final UserEnitity userLoggedIn = UserHolder.getInstance().getUser();

    @FXML
    private TableView<UserEnitity> class_table;
    ...
    private void getAndRenderStudentList() {
        try {
            ...
            String sql = "SELECT u.user_id, u.first_name, u.last_name, u.user_name, u.gender, u.date_of_birth, u.email," +
                    ...
                    "AND class.class_id = " + userLoggedIn.getCurrent_children_viewing().getClassEnitity().getClass_id() + " " +
            ...
            while (dataStudents.next()) {
                ...
                class_table.setItems(studentList);
